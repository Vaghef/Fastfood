...
namespace Fastfood.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "حداقل شش کاراکتر برای کلمه عبور وارد نمایید", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "تایید کلمه عبور با کلمه عبور یکسان نیست")]
